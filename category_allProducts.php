...
<div class="header-topbar1">
    ...
    <form id="search-header-form" method="get" class="woocommerce-product-search" action="search">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-605"><a href="#">Buy Now!</a></li>
			...
			<div class="col-xs-6 col-md-3">
					...
					<a class="cart-contents" href="viewCart.php">
						<h6>Shopping Cart</h6>
						<span><?php if(isset($_SESSION['total_items'])) { echo $_SESSION['total_items']; } else {echo "0";} ?> item(s) - <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#x20a8; </span><?php if(isset($_SESSION['total_price'])) { echo $_SESSION['total_price']; }?></span></span>
					</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 ">
						...
						<nav class="woocommerce-breadcrumb" ><a href="#">Home</a> <i class="fa fa-angle-right"></i><span id="categoryName"> <?php echo $category; ?></span></nav>
					</div>
				</div>
			</div>
		</div>
...
<div class="clear"></div><div class="woocommerce product compare-button"><a href="#" class="compare button" data-product_id="556" rel="nofollow">Compare</a></div>				
			<!--	<div class="quickview-button">
              ...
              <a class="quickview" href="productDetails.php?category=<?php echo $category; ?>&id=<?php echo $products['pid']; ?>" >Quick View</a>	
