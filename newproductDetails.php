			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 ">
						...
						<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><a href="#">Home</a> <i class="fa fa-angle-right"></i> <a href="#">Tools &amp; Accessories</a> <i class="fa fa-angle-right"></i> <a href="#">Hair Styling Tools</a> <i class="fa fa-angle-right"></i> Maxtop Electric Hair Straightener Comb Brush</nav>				
					</div>			
				</div>
			</div>
		</div>
...
<div itemscope itemtype="http://schema.org/Product" id="product-556" class="post-556 product type-product status-publish has-post-thumbnail product_cat-conditioners product_cat-hair-care product_cat-hair-oils product_cat-hair-styling-tools product_cat-hair-treatments product_cat-shampoos product_cat-tools-accessories product_tag-accessories product_tag-women product_brand-reebok product_brand-umbro product_brand-vans first instock sale taxable shipping-taxable purchasable product-type-simple">
	...
	<div id="product-image">
		...
		<div class="single-product-title"><h1 itemprop="name" class="product_title entry-title">Maxtop Electric Hair Straightener Comb Brush</h1>					<div class="product-next-previous">
	...
	<p class="price"><del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>445.00</span></del> <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>225.00</span></ins></p>
...
<p >Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p>
	...
	<div id="comments">
		<h2 class="woocommerce-Reviews-title">3 reviews for <span>Maxtop Electric Hair Straightener Comb Brush</span></h2>
