...
$fetchCategoryIdQuery = mysqli_query($conn,"select * from categories where category = '$category'");

$fetchCayegoryId = mysqli_fetch_array($fetchCategoryIdQuery);

$category_id = $fetchCayegoryId['cid'];

?>

<?php

$fetchSubcategoryNameQuery = mysqli_query($conn,"select * from subcategories where sid='$id'");

$fetchSubategory = mysqli_fetch_array($fetchSubcategoryNameQuery);

$subcategory = $fetchSubategory['subcategory'];

$subcategoryId = $fetchSubategory['sid'];
...
<ul class="cart_list product_list_widget ">
				...
				<div class="row">
					<div class="col-xs-12 ">
								...
								<div class="page-header">
																	<h1 class="page-title"><?php echo $subcategory; ?></h1>
																</div>

						<nav class="woocommerce-breadcrumb" ><a href="index.php">Home</a> <i class="fa fa-angle-right"></i><?php echo $category; ?> <i class="fa fa-angle-right"></i><span id="categoryName"> <?php echo $subcategory; ?></span></nav>
					</div>
				</div>
			</div>
		</div>
	...
	<input type="hidden" name="add_to_wishlist" value="556" /><input type="hidden" name="add-to-cart" value="556" /></form>
		...
		<ul class="products product-style1 is_shop grid grid-view" data-navigation="1" data-pagination="0"  id="filteredProducts">
...
<div class="clear"></div><div class="woocommerce product compare-button"><a href="#" class="compare button" data-product_id="556" rel="nofollow">Compare</a></div>				
		...
		<a class="product-title" href="productDetails.php?category=<?php echo $category; ?>&id=<?php echo $products['pid']; ?>"> <h3><?php echo $products['name']; ?></h3> </a>
...
<?php } ?>
	...
	<div id="secondary" class="secondary">
			...
			<!--			<li class="cat-item cat-item-45"><a href="Flowrist2.html">cetegory</a> <span class="count">(2)</span></li>
						<li class="cat-item cat-item-48"><a href="#">Fragrance</a> <span class="count">(4)</span></li>
						<li class="cat-item cat-item-44 current-cat cat-parent"><a href="#">Hair Care</a> <span class="count">(2)</span>
							<ul class='children'>
								<li class="cat-item cat-item-58"><a href="#">Conditioners</a> <span class="count">(1)</span></li>
								<li class="cat-item cat-item-59"><a href="#">Hair Oils</a> <span class="count">(2)</span></li>
								<li class="cat-item cat-item-60"><a href="#">Hair Treatments</a> <span class="count">(2)</span></li>
								<li class="cat-item cat-item-57"><a href="#">Shampoos</a> <span class="count">(1)</span></li>
							</ul>
						</li>
						<li class="cat-item cat-item-41"><a href="#">Luxury Beauty</a> <span class="count">(3)</span></li>
						<li class="cat-item cat-item-42"><a href="#">Make-Up &amp; Nails</a> <span class="count">(2)</span></li>
						<li class="cat-item cat-item-46"><a href="#">Mens Grooming</a> <span class="count">(4)</span></li>
						<li class="cat-item cat-item-43"><a href="#">Skin Care</a> <span class="count">(4)</span></li>
						<li class="cat-item cat-item-47"><a href="#">Tools &amp; Accessories</a> <span class="count">(5)</span></li>-->
						
						
						<?php $fetchAllCategories = mysqli_query($conn,"select * from categories"); 
						
						while($allCategories = mysqli_fetch_array($fetchAllCategories))
						{
							        $categoryId = $allCategories['cid'];
						?>

						
						<li class="cat-item cat-item-44 current-cat cat-parent"><a href="category_allProducts.php?id=<?php echo $categoryId; ?>"><?php echo $allCategories['category']; ?></a>
						
							<ul class='children'>


						<?php $fetchSucategoryQuery = mysqli_query($conn,"select * from subcategories where cid='$categoryId'");
						
						while($fetchSubcategory = mysqli_fetch_array($fetchSucategoryQuery))
						{
							?>
								<li class="cat-item cat-item-58"><a href="subcategory_allProducts.php?category=<?php echo $allCategories['category']; ?>&id=<?php echo $fetchSubcategory['sid']; ?>"><?php echo $fetchSubcategory['subcategory']; ?></a> </li>
						<?php } ?>		
							</ul>
						</li>
...
<?php $fetchMaxPriceQuery = mysqli_query($conn,"select max(price) AS max from products"); 

	 $fetchMaxPrice = mysqli_fetch_array($fetchMaxPriceQuery);
	 $maxPrice = $fetchMaxPrice['max'];
...
<form method="post" id="filterform" action="#">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<input type="text" id="max_price" name="max_price" value="" data-max="<?php echo $maxPrice; ?>" placeholder="Max price" />
	...
	<div class="product-details">
		...
		<del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>445.00</span></del> <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>225.00</span></ins>		</span>
	</div>
</li>
...
<!--					<li class="slide-row">
	...
	<div class="product-details">
		...
		<del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>175.00</span></del> <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>100.00</span></ins>		</span>
	</div>
</li>
												</ul>
						</li>-->
...
$("#filterform").submit(function(e){
              ...
              var dataString = "min_price="+minPrice+"&max_price="+maxPrice;

                          $.ajax({
                          type: "POST",
                          url: "get_filtered_products.php",
                          data: dataString,
...
//	var categoryName = $('nav.woocommerce-breadcrumb span#categoryName').text();
	
	
	// $('ul#productCategories li.current-cat').removeClass('current-cat');
    // $('ul#productCategories li:contains("c1")').addClass('current-cat');

 
 var categoryName = "<?php echo $subcategory; ?>";
 
    $('ul#productCategories li.current-cat').removeClass('current-cat');
    $('ul#productCategories li:contains("'+categoryName+'")').addClass('current-cat');
