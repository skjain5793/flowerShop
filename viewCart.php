...
.search-area .search-bar-controls .search-btn {
    ...
    padding: -0.3219em 1.2871em!important;
...
.footer .widget {
    ...
    border: 1px #3b589c solid !important;
}
...
.M{border: 1px #ded3d3 SOLID!IMPORTANT;}
...
.site-main {
    background-image: url(list.png)!important;
...
<link rel='stylesheet' id='font-awesome-css'  href='css07/font-awesome.min1c9b.css?ver=4.6.1' type='text/css' media='all' />
<link rel='stylesheet' id='azexo-skin-css'  href='css07/skin-c32dace8d2.css' type='text/css' media='all' />
<link rel='stylesheet' id='azexo-style-css'  href='css07/style1c9b.css?ver=4.6.1' type='text/css' media='all' />
<script type='text/javascript' src='js07/jqueryb8ff.js?ver=1.12.4'></script>
...
<style id='product-style-inline-css' type='text/css'>
	...
	*/
	...
	.product-toolbar .gridlist-toggle > a, table, th, td,.emallshop-main-menu .emallshop-vertical-menu, .widget, .secondary .widget > select,.widget .tagcloud a, .widget.yith-woocompare-widget .clear-all, .comment-area-wrap, .comment-avatar img, .comment-respond, .single-product-entry .thumbnails-carousel .owl-item .item, .woocommerce .single-product-entry .entry-summary .quantity .qty, .woocommerce-tabs .panel, .product-section .section-inner, .woocommerce .col2-set .col-1, .woocommerce-page .col2-set .col-1, .woocommerce .col2-set .col-2,.woocommerce-page .col2-set .col-2, .woocommerce .woocommerce-pagination ul.page-numbers span, .woocommerce .woocommerce-pagination ul.page-numbers a, .related-posts .hentry, .services ul.services .service-item, .testimonials-section .quote-meta  .client-image, .blogs_carousel .blog-entry .hentry, input, textarea, .woocommerce div.product .woocommerce-tabs ul.tabs li, .blog-posts .hentry, .portfolio-list .portfolioFilter a, .portfolio-list .hentry, .related-portfolios .hentry, .woocommerce form.checkout_coupon, .woocommerce form.login, .woocommerce form.register, .search-area, select, .emallshop-vertical-menu.main-navigation, .navigation.comment-navigation .nav-links, .search-control-group .tt-menu, .header-services .icon-service, .product-section .section-tab .nav-tabs li a, .single-product-entry .images #product-image{
		...
		border-left:1px;
		border-right:1px;
		border-style:solid;border-color: #3b589c;
	}
...
<link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed54d8.json?url=http%3A%2F%2Fdemo.presslayouts.com%2Femallshop%2Fbeauty%2Fcart%2F" />
<link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed61c1?url=http%3A%2F%2Fdemo.presslayouts.com%2Femallshop%2Fbeauty%2Fcart%2F&amp;format=xml" />
...
<body class="page-template-default page page-id-45 sticky-navigation woocommerce-cart woocommerce-page yith-wcan-free wpb-js-composer js-comp-ver-5.0 vc_responsive">
		...
		<div class="header-logo" style="float:right;">
			...
			<div class="col-sm-5">
				<div class="header-right">
							<aside  class="widget coming_stay_connected" style="    border: 1px #3b589c solid !important;">
...
<li  id="menu-item-606"  class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-606 emallshop-megamenu-menu"  ><a    href="my-account/index.html">My Account<span class="emallshop-menu-label"></span> </a>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-605"><a href="#">Buy Now!</a></li>
			...
			<div class="col-xs-6 col-md-3">
					...
					<a class="cart-contents" href="viewCart.php">
						<h6>Shopping Cart</h6>
						<span><?php if(isset($_SESSION['total_items']))
{ echo $_SESSION['total_items']; } else { echo "0"; } ?> item(s) - <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#x20a8; </span><?php if(isset($_SESSION['total_price'])){ echo $_SESSION['total_price']; } else { echo "0"; } ?></span></span>
					</a>
...
<div id="primary" class="content-area">
        <div id="content" class="site-content" role="main">
                    <div id="post-209" class="entry post-209 page type-page status-publish hentry">
                <div class="entry-content">
                    <p><div class="woocommerce">

					
<!--		<form action="http://azexo.com/foodpicky/cart/" method="post" > -->
...
<table class="shop_table shop_table_responsive cart" cellspacing="0" >
	...
	<tbody>
        ...
        if($cart->total_items() > 0){
          ...
          $_SESSION['total_items'] = $cart->total_items();
        ...
        ?>
					...
					<td class="product-remove">
						<a href="cartAction.php?action=removeCartItem&id=<?php echo $item["rowid"]; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="material-icons">delete</i></a>		</td>

					<td class="product-thumbnail">
						<a href="#"><img width="180" height="180" src="admin/products/<?php echo $item["image"]; ?>" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="pic" srcset="admin/products/<?php echo $item["image"]; ?> 180w, http://azexo.com/foodpicky/wp-content/uploads/2016/09/Pic-150x150.jpg 150w, http://azexo.com/foodpicky/wp-content/uploads/2016/09/Pic-300x300.jpg 300w, http://azexo.com/foodpicky/wp-content/uploads/2016/09/Pic-100x100.jpg 100w" sizes="(max-width: 180px) 100vw, 180px" /></a>					</td>

					<td class="product-name" data-title="Product">
						<a href="#"><?php echo $item["name"]; ?></a>
					<!--	<dl class="variation">
			<dt class="variation-SoldBy">Sold By:</dt>
		<dd class="variation-SoldBy"><p><a href="vendors/pastaria/index.html" target="_TOP">pastaria </a></p>
</dd>
	</dl> -->
					</td>

					<td class="product-price" data-title="Price">
						<span class="woocommerce-Price-amount amount"><span class="currency"><span class="woocommerce-Price-currencySymbol">Rs. </span></span><?php echo $item["price"]; ?></span>					</td>

					<td class="product-quantity" data-title="Quantity">

<!--    <div class="quantity"> -->
<input type="number" class="form-control text-center" value="<?php echo $item["qty"]; ?>" onchange="updateCartItem(this, '<?php echo $item["rowid"]; ?>')">   <!-- </div> -->
					</td>

					<td class="product-subtotal" data-title="Total" style="margin-left:40px;">
						<span class="woocommerce-Price-amount amount"><span class="currency"><span class="woocommerce-Price-currencySymbol">Rs. </span></span><?php echo $item["subtotal"]; ?>				</td>
				</tr>
        ...
        <?php } ?>
			...
			<!--	<input type="submit" class="button" name="update_cart" value="Update Cart" />
				...
				<input type="hidden" id="_wpnonce" name="_wpnonce" value="4500573433" /><input type="hidden" name="_wp_http_referer" value="/foodpicky/cart/" /> -->			</td>
		</tr>
...
<div class="cart-collaterals">
	...
	<div class="cart_totals ">
		 ...
		 $_SESSION['total_price'] = $cart->total();
         ?>
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="order-total">
			<th>Total</th>
			<td data-title="Total"><strong><span class="woocommerce-Price-amount amount"><span class="currency"><span class="woocommerce-Price-currencySymbol">Rs. </span></span><?php echo $cart->total(); ?></span></strong> </td>
		</tr>
...
<script type='text/javascript' src='wp-content/themes/emallshop/js/bootstrap.min.js'></script>
