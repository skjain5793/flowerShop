...
$fetchReviewsQuery = mysqli_query($conn,"select * from reviews where pid = '$id'");

$totalReviews = mysqli_num_rows($fetchReviewsQuery);

$fetchDetailsQuery = mysqli_query($conn,"select * from products where pid = '$id'");

$productDetails = mysqli_fetch_array($fetchDetailsQuery);
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-605"><a href="#">Buy Now!</a></li>
			...
			<div class="col-xs-6 col-md-3">
					...
					<a class="cart-contents" href="viewCart.php">
						<h6>Shopping Cart</h6>
						<span><?php if(isset($_SESSION['total_items'])){ echo $_SESSION['total_items'];} else { echo "0"; } ?> item(s) - <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#x20a8; </span><?php if(isset($_SESSION['total_price'])){echo $_SESSION['total_price'];} else { echo "0";} ?></span></span>
					</a>
...
<ul class="cart_list product_list_widget ">
		...
		<li class="empty"><?php if(isset($_SESSION['total_items'])) {echo $_SESSION['total_items'];}else{ echo "No"; } ?> products in the cart.</li>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 ">
						...
						<a href="#"><?php echo $category; ?></a> <i class="fa fa-angle-right"></i> <?php echo $productDetails['name']; ?></nav>				
					</div>			
				</div>
			</div>
		</div>
...
<div itemscope itemtype="http://schema.org/Product" id="product-556" class="post-556 product type-product status-publish has-post-thumbnail product_cat-conditioners product_cat-hair-care product_cat-hair-oils product_cat-hair-styling-tools product_cat-hair-treatments product_cat-shampoos product_cat-tools-accessories product_tag-accessories product_tag-women product_brand-reebok product_brand-umbro product_brand-vans first instock sale taxable shipping-taxable purchasable product-type-simple">
	<div class="single-product-entry">
		<div class="row">
			<div class="col-xs-12 col-md-5">
				...
				<div class="onsale"><span></span></div>			
			</div>
		<div class="images">
	<div id="product-image">
					
				<!--<img id="outer-zoom" src="wp-content/uploads/2016/10/Maxtop-Electric-Hair-Straightener-Comb-Brush-620x726.jpg" data-large="http://demo.presslayouts.com/emallshop/beauty/wp-content/uploads/2016/10/Maxtop-Electric-Hair-Straightener-Comb-Brush.jpg" alt="" />-->
				<img id="outer-zoom" src="admin/products/<?php echo $productDetails['image']; ?>"  data-large="http://demo.presslayouts.com/emallshop/beauty/admin/products/<?php echo $productDetails['image']; ?>" alt="" >

				</div>
		<div class="thumbnails columns-3 thumbnails-carousel owl-carousel">		

	<?php	$imageGallery = unserialize($productDetails['image_gallery']);
		...
		?>
				...
				<div class="item">
					...
					<img width="120" height="140" src="admin/image_gallery/<?php echo $imageGallery[$i]; ?>" class="lazyOwl" alt=""  title="" />	
				</div>
		...
		<div class="single-product-title"><h1 itemprop="name" class="product_title entry-title"><?php echo $productDetails['name']; ?></h1>					<div class="product-next-previous">
		...
		<?php
        $user_rating = 0;		
		while($fetchAllReviews = mysqli_fetch_array($fetchReviewsQuery)){
			$user_rating += $fetchAllReviews['rating'];
		} 
		 $user_rating;
		 $total_rating = $totalReviews*5;
		 $total_star_rating =  @($user_rating/$total_rating)*100;
		?>
	...
	<div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
		<div class="star-rating" title="Rated 4 out of 5">
			...
			<span style="width:<?php echo $total_star_rating; ?>%">
				<strong itemprop="ratingValue" class="rating">4</strong> out of <span itemprop="bestRating">5</span>				based on <span itemprop="ratingCount" class="rating"><?php echo $totalReviews; ?></span> customer ratings			
			</span>
		</div>
		<a href="#reviews" class="woocommerce-review-link" rel="nofollow">(<span itemprop="reviewCount" class="count">
				<?php echo $totalReviews; ?></span> customer reviews)
		</a>	
	    </div>
	...
	<p class="price"><del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span><?php echo $productDetails['actual_price']; ?></span></del> <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span><?php echo $productDetails['price']; ?></span></ins></p>
	...
	<form class="cart" action="#" method="post" id="addToCartForm">
	 	
	 	<div class="quantity">
	<input type="number" step="1" min="1" max="" id="quantity" name="quantity" value="1" title="Qty" class="input-text qty text" size="4" pattern="[0-9]*" inputmode="numeric" />
</div>

<input type="hidden" name="product_id" value = "<?php echo $productDetails['pid']; ?>"

	 	<input type="hidden" name="add-to-cart" value="556" />

	 	<button type="button" class="single_add_to_cart_button button alt" id="<?php echo $productDetails['pid']; ?>"><a  href="cartAction.php?action=addToCart&id=<?php echo $productDetails['pid']; ?>">Add to cart<a></button>
...
<div class="clear"></div>
<!--<a href="#" class="compare button" data-product_id="556" rel="nofollow">Compare</a>-->
<div class="product_meta">


<?php $fetchCategories = mysqli_query($conn,"select * from categories"); ?>	 
		
		<span class="posted_in">Categories: 
		
<?php while($allCategories = mysqli_fetch_array($fetchCategories))
{ ?>		
			<a href="category_allProducts.php?id=<?php echo $allCategories['cid']; ?>" rel="tag"><?php echo $allCategories['category']; ?></a>,
...
<div class="social-share-button"><style type="text/css" scoped="scoped">
					...
					.social-share-linkedin, .social-share-twitter{margin-top: .2em;}
						...
						<a href="#" class="twitter-share-button" data-url="http://demo.presslayouts.com/emallshop/beauty/product/maxtop-electric-hair-straightener-comb-brush/" data-text="Maxtop Electric Hair Straightener Comb Brush" data-count="horizontal">Tweet</a><script type="text/javascript" src="../platform.twitter.com/widgets.js"></script>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper">
		<ul class="tabs wc-tabs">
					...
					<a href="#tab-reviews">Reviews (<?php echo $totalReviews; ?>)</a>
				</li>
					</ul>
...
<p ><?php echo $productDetails['description']; ?></p>
	...
	<div id="comments">
		<h2 class="woocommerce-Reviews-title"><?php echo $totalReviews; ?> reviews for <span><?php echo $productDetails['name']; ?></span></h2>
			...
			<?php 
			$fetchQuery = mysqli_query($conn,"select * from reviews where pid = '$id'");
			while($fetchReviews = mysqli_fetch_array($fetchQuery))
			{
				$rating = $fetchReviews['rating'];
	...
	<div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="Rated 4 out of 5">
		<span style="width:<?php echo $starRating; ?>%"><strong itemprop="ratingValue"><?php echo $fetchReviews['rating']; ?></strong> out of 5</span>
	</div>


	<p class="meta">
		<strong itemprop="author"><?php echo $fetchReviews['name']; ?></strong> &ndash; <time itemprop="datePublished" datetime="2016-11-17T12:39:03+00:00"><?php echo $fetchReviews['datetime']; ?></time>
	</p>

<div itemprop="description" class="description"><p><?php echo $fetchReviews['comment']; ?></p>
</div>
		</div>
	</div>
</li>
		...
		<form action="submitreview.php" method="post" id="commentform" class="comment-form" novalidate>
				...
				<p class="comment-form-email">
					...
					<input id="email" name="useremail" type="email" value="" size="30" aria-required="true" required />
				</p>
				<p class="form-submit">
					<input type="submit" id="submit" name="submitreview" class="submit" value="Submit" /> 
	...
	<?php $fetchCategoryQuery = mysqli_query($conn,"select * from categories where category = '$category'"); 
		$fetchCategory = mysqli_fetch_array($fetchCategoryQuery);
	...
	?>	
       ...
       $fetchSubcategoryQuery = mysqli_query($conn,"select * from subcategories where cid = '$categoryId'");
		...
		<?php 
			...
			while($fetchProducts = mysqli_fetch_array($fetchProductsQuery))
			{
		?>
	...
	<!--	<img width="300" height="351" src="wp-content/uploads/2016/10/Cream-PondS-Gold-Radiance-Youthful-50gm-300x351.jpg" class="front-image wp-post-image" alt="" />-->


<img width="300" height="351" src="admin/products/<?php echo $fetchProducts['image']; ?>" class="front-image wp-post-image" alt="" />
		
		
		<ul class="product_image_gallery owl-carousel owl-theme"><li>
		<!--<img width="300" height="351" src="wp-content/uploads/2016/10/Cream-PondS-Gold-Radiance-Youthful-50gm-300x351.jpg" class="front-image wp-post-image" alt="" /></li><li><img width="300" height="351" src="wp-content/uploads/2016/10/Balancing-Lotus-Herbals-Youth-Rx-pH-300x351.jpg" class="attachment-shop_catalog size-shop_catalog" alt="" /></li><li><img width="300" height="351" src="wp-content/uploads/2016/10/Oriflame-Seductive-Musk-Eau-De-Toilette-300x351.jpg" class="attachment-shop_catalog size-shop_catalog" alt="" />-->
		</li><li>
		<!--<img width="300" height="351" src="wp-content/uploads/2016/10/Cream-PondS-Gold-Radiance-Youthful-50gm-300x351.jpg" class="attachment-shop_catalog size-shop_catalog" alt="" />-->
		</li></ul></a>			<div class="product-slider-controls owl-nav post-561">
...
<div class="clear"></div><div class="woocommerce product compare-button"><a href="#" class="compare button" data-product_id="561" rel="nofollow">Compare</a></div>				<div class="quickview-button">
		...
		<div class="product-title-rating">		<a class="product-title" href="productDetails.php?id=<?php echo $fetchProducts['pid']; ?>">
		<h3><?php echo $fetchProducts["name"]; ?></h3>		</a>
	...
	<span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">Rs. </span><?php echo $fetchProducts['price']; ?></span></span>
			
		</div>		
		<div class="product-buttons">  	
				
		<div class="product-cart">  	
		<a rel="nofollow" href="cartAction.php?action=addToCart&id=<?php echo $fetchProducts['pid']; ?>" data-quantity="1" data-product_id="561" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>		
		</div>        	
...
<div class="clear"></div><div class="woocommerce product compare-button"><a href="#" class="compare button" data-product_id="561" rel="nofollow">Compare</a></div>			<div class="quickview-button">
	...
	<div id="secondary" class="secondary">
		...
		<?php $fetchRecentProductsQuery = mysqli_query($conn,"select * from  products order by pid DESC limit 10"); 
		while($recentProducts = mysqli_fetch_array($fetchRecentProductsQuery))
		{
		?>							
	...
	<div class="product-image">
		<a href="#" title="Balancing Lotus Herbals Youth Rx pH">
			<img width="120" height="140" src="admin/products/<?php echo $recentProducts['image']; ?>" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" />		</a>
	</div>
	<div class="product-details">
		<a href="#" title="Balancing Lotus Herbals Youth Rx pH">
			<span class="product-title"><a href="productDetails.php?id=<?php echo $recentProducts['pid']; ?>"><?php echo $recentProducts['name']; ?></a></span>
		</a>
	<!--	<div class="star-rating" title="Rated 5 out of 5"><span style="width:100%"><strong class="rating">5</strong> out of 5</span></div>		<span class="product-price">-->
		<del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">Rs.</span><?php echo $recentProducts['actual_price']; ?></span></del> <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"> Rs. </span><?php echo $recentProducts['price']; ?></span></ins>		</span>
	</div>
</li>						
...
var quantity = $("input#quantity").val();
                   ...
                   $.ajax({
                   url: "add_cart.php?action=add&pid="+id+"&quantity="+quantity,
                   success: function(response){
					   $("button#"+id).css("background-color","green").text("Added to cart");
                          }
                          });
